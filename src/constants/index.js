...
export const FED_CANDIDATE_EVENTS = [NO_EVENTS, CAMPAIGN_TOWN_HALL, OTHER, TICKETED_EVENT, TELE_TOWN_HALL];
export const STATE_CANDIDATE_EVENTS = [NO_EVENTS, CAMPAIGN_TOWN_HALL, OTHER, TICKETED_EVENT, TELE_TOWN_HALL];
